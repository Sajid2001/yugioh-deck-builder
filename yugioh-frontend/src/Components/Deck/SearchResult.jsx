...
export default function SearchResult({card, section}) {
  ...
  return (
    <div className='bg-white p-3 m-2 rounded-lg'>
        <div className='flex flex-row'>
            ...
            <div className='flex flex-col items-center justify-center'>
                ...
                <span>
                    <button onClick={() => changeQuantity(quantity - 1)} className='p-2 font-bold text-white bg-blue-500 hover:bg-blue-700 m-2 rounded-lg transition-duration-200 transition-all ease-in'>-</button>
                    {quantity}
                    <button onClick={() => changeQuantity(quantity + 1)} className='p-2 font-bold text-white bg-blue-500 hover:bg-blue-700 m-2 rounded-lg transition-duration-200 transition-all ease-in'>+</button>
                </span>
                <button onClick={addCard} className='bg-blue-500 transition-duration-200 transition-all ease-in hover:bg-blue-700 p-3 w-2/3 mt-4 rounded-lg text-white'>Add Card To {section.name}</button>
            </div>
        </div>
    {error && 
