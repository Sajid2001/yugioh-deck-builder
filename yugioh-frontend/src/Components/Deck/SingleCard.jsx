...
export default function SingleCard({userId, card}) {
  ...
  return (
    <div className='m-1 p-2 relative'>
        ...
        <button onClick={navigateToCard} className='m-1 bg-orange-400 p-2 rounded-md hover:bg-orange-600 transition-all transition-duration-200 ease-in'>
